...
from ruamel.yaml.compat import _debug, check_anchorname_char, nprint, nprintf  # NOQA
from ruamel.yaml.docinfo import Tag, Version  # NOQA
...
#
from ruamel.yaml.error import CommentMark, MarkedYAMLError  # NOQA
from ruamel.yaml.tokens import *  # NOQA

if False:  # MYPY
    from typing import Any, Dict, Optional, List, Union, Text, Tuple  # NOQA

__all__ = ['RoundTripScanner', 'Scanner', 'ScannerError']
    ...
    def scan_block_scalar_indentation(self) -> Any:
        ...
        while srp() in ' \r\n\x85\u2028\u2029':
            if srp() != ' ':
                ...
                srf()
                max_indent = max(max_indent, self.reader.column)
        ...
        while True:
            ...
            while True:
                ...
                if False and ch == ':' and srp(length + 1) == ',':
                    break
                if (ch == ':' and srp(length + 1) not in _THE_END_SPACE_TAB) or (ch == '?' and self.scanner_processing_version != (1, 1)):
                    pass
                elif (
    ...
    def scan_line_break(self, empty_line: bool = False) -> str:
        ...
        if ch in '\r\n\x85':
            if self.reader.prefix(2) == '\r\n':
                ...
                self.reader.forward()
            return '\n'
        if ch in '\u2028\u2029' or (empty_line and ch in '\t '):
            self.reader.forward()
            return ch
        return ""
...
class CommentBase:
    __slots__ = ('column', 'fline', 'function', 'line', 'ufun', 'uline', 'used', 'value')
