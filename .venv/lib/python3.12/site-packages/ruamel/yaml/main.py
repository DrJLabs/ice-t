...
from ruamel.yaml.dumper import BaseDumper, Dumper, RoundTripDumper, SafeDumper
from ruamel.yaml.error import UnsafeLoaderWarning, YAMLError  # NOQA
from ruamel.yaml.events import *  # NOQA
from ruamel.yaml.loader import BaseLoader, Loader, RoundTripLoader, SafeLoader
...
class YAML:
    def __init__(
        self: Any,
        *,
        typ: Optional[Union[List[str], str]] = None,
        pure: Any = False,
        output: Any = None,
        plug_ins: Any = None,
    ) -> None:  # input=None,
    ...
    def constructor(self) -> Any:
        ...
        if not hasattr(self, attr):
            ...
            cnst = self.Constructor(preserve_quotes=self.preserve_quotes, loader=self)  # type: ignore
