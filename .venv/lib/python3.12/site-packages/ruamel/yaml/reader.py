...
class Reader:
    ...
    @classmethod
    def _get_non_printable_regex(cls, data: str) -> Optional[Tuple[int, str]]:
    ...
    @classmethod
    def _get_non_printable(cls, data: str) -> Optional[Tuple[int, str]]:
        try:
        ...
        while len(self.buffer) < length:
            ...
            if self.raw_decode is not None:
                try:
                    ...
                    if self.stream is not None or self.stream is not None:
