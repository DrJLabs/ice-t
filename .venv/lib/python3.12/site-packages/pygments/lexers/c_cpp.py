...
class CFamilyLexer(RegexLexer):
    ...
    def get_tokens_unprocessed(self, text, stack=('root',)):
        for index, token, value in \
            ...
            if token is Name:
                if (self.stdlibhighlighting and value in self.stdlib_types) or (self.c99highlighting and value in self.c99_types) or (self.c11highlighting and value in self.c11_atomic_types) or (self.platformhighlighting and value in self.linux_types):
                    token = Keyword.Type
