...
class CudaLexer(CLexer):
    ...
    def get_tokens_unprocessed(self, text, stack=('root',)):
        for index, token, value in CLexer.get_tokens_unprocessed(self, text, stack):
            if token is Name:
                if value in self.variable_qualifiers or value in self.vector_types:
                    token = Keyword.Type
...
class ArduinoLexer(CppLexer):
    ...
    variables = {
        ...
        'LOW', 'INPUT', 'OUTPUT', 'true', 'false',
        'void', 'boolean', 'char', 'unsigned char', 'byte', 'int', 'unsigned int',
        'word', 'long', 'unsigned long', 'short', 'float', 'double', 'string', 'String',
        'array', 'static', 'volatile', 'const', 'private', 'virtual', 'operator',
        'sizeof', 'uint8_t', 'uint16_t', 'uint32_t', 'uint64_t', 'int8_t', 'int16_t',
        'int32_t', 'int64_t', 'dynamic_cast', 'typedef', 'const_cast', 'struct', 'static_cast', 'union', 'unsigned', 'protected', 'bool', 'public', 'friend', 'auto', 'enum', 'extern',
        'class', 'reinterpret_cast', 'register', 'explicit',
    ...
    functions = {
        ...
        'readGreen', 'writeBlue', 'startLoop', 'isPressed', 'sendSysex',
