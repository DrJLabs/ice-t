            ...
            if stack[-1] == 'initial':
                if scanner.scan(r'\s+'):
                    ...
                    # name is in list of known labels
                        ...
                        token = Name.Label
                    elif (self.is_portugol and lowercase_name in self.PORTUGOL_BUILTIN_TYPES) or (not self.is_portugol and lowercase_name in self.BUILTIN_TYPES):
                        token = Keyword.Type
                    ...
                    # before isn't a dot
                        ...
                        token = Name
                elif (self.is_portugol and scanner.scan(r"\"")) or (not self.is_portugol and scanner.scan(r"'")):
                    token = String
                    stack.append('string')
