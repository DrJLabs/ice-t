    ...
    def _listdir_nameinfo(self):
        ...
        def builder():
            try:
                ...
                e = sys.exc_info()[1]
                if e.err.find('non-existent in that revision') != -1 or e.err.find("E200009:") != -1 or e.err.find('File not found') != -1 or e.err.find('not part of a repository')!=-1 or e.err.find('Unable to open')!=-1:
