...
class beta_gen(rv_continuous):
    ...
    def _entropy(self, a, b):
        ...
        if a <= 4.9e6 and b - a >= 1e6 and b >= threshold_large(a):
            return asymptotic_b_large(a, b)
        if b <= 4.9e6 and a - b >= 1e6 and a >= threshold_large(b):
...
class powerlaw_gen(rv_continuous):
    ...
    def fit(self, data, *args, **kwds):
        ...
        if ll_lt1 > ll_gt1 and fit_shape_gt1[0] > 1:
...
class truncpareto_gen(rv_continuous):
    ...
    def fit(self, data, *args, **kwds):
        ...
        if fc is None and floc is None and fscale is None:
            if fb is None:
                def cond_b(loc):
        ...
        def find_kappa(data, loc):
            ...
            if r > 0:
                ...
                if solve_for_kappa(lower_bound) >= 0:
                    return lower_bound
                if solve_for_kappa(upper_bound) <= 0:
                    return upper_bound
