...
def _generate_domain_support(dist_family):
    ...
    if n_parameterizations == 0:
        ...
        number = {2: 'two', 3: 'three', 4: 'four', 5: 'five'}[
            n_parameterizations]
        parameterizations = [f"- {p!s}" for p in
...
class ContinuousDistribution(_ProbabilityDistribution):
    ...
    def _moment_central_general(self, order, **params):
        ...
        return general_central_moments.get(order)
    ...
    def _moment_standardized_general(self, order, **params):
        ...
        return general_standard_moments.get(order)
...
class TruncatedDistribution(TransformedDistribution):
    ...
    def __repr__(self):
        with np.printoptions(threshold=10):
            return (f"truncate({self._dist!r}, "
                    f"lb={self.lb!r}, ub={self.ub!r})")

    def __str__(self):
        with np.printoptions(threshold=10):
            return (f"truncate({self._dist!s}, "
                    f"lb={self.lb!s}, ub={self.ub!s})")
...
class OrderStatisticDistribution(TransformedDistribution):
    ...
    def __repr__(self):
        with np.printoptions(threshold=10):
            return (f"order_statistic({self._dist!r}, r={self.r!r}, "
                    f"n={self.n!r})")

    def __str__(self):
        with np.printoptions(threshold=10):
            return (f"order_statistic({self._dist!s}, r={self.r!s}, "
                    f"n={self.n!s})")
