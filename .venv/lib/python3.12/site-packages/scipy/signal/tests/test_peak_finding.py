...
def test_unpack_condition_args():
    ...
    assert _unpack_condition_args((None, None), x, peaks) == (None, None)
    assert _unpack_condition_args(1, x, peaks) == (1, None)
    assert _unpack_condition_args((1, None), x, peaks) == (1, None)
    assert _unpack_condition_args((None, 2), x, peaks) == (None, 2)
    assert _unpack_condition_args((3., 4.5), x, peaks) == (3., 4.5)
