...
def is_same_type(
    ...
    if isinstance(a, TypeVarType) and isinstance(b, TypeVarType) and a.id == b.id:
        return True
...
class SubtypeVisitor(TypeVisitor[bool]):
    ...
    def visit_callable_type(self, left: CallableType) -> bool:
        ...
        if isinstance(right, Overloaded):
            ...
            if is_named_instance(right, TUPLE_LIKE_INSTANCE_NAMES):
                ...
                for li in left.items:
                    ...
                    if not self._is_subtype(li, iter_type):
                        return False
                return True
            if self._is_subtype(left.partial_fallback, right) and self._is_subtype(
