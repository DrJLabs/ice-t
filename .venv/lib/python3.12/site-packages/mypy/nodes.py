...
class Context:
    ...
    __slots__ = ("column", "end_column", "end_line", "line")
...
class ImportBase(Statement):
    ...
    __slots__ = ("assignments", "is_mypy_only", "is_top_level", "is_unreachable")
...
class OverloadedFuncDef(FuncBase, SymbolNode, Statement):
    ...
    __slots__ = ("_is_trivial_self", "deprecated", "impl", "items", "unanalyzed_items")
...
class Argument(Node):
    ...
    __slots__ = ("initializer", "kind", "pos_only", "type_annotation", "variable")
...
class TypeParam:
    __slots__ = ("default", "kind", "name", "upper_bound", "values")
...
class Decorator(SymbolNode, Statement):
    ...
    __slots__ = ("decorators", "func", "is_overload", "original_decorators", "var")
...
class TryStmt(Statement):
    __slots__ = ("body", "else_body", "finally_body", "handlers", "is_star", "types", "vars")
...
class WithStmt(Statement):
    __slots__ = ("analyzed_types", "body", "expr", "is_async", "target", "unanalyzed_type")
...
class MatchStmt(Statement):
    __slots__ = ("bodies", "guards", "patterns", "subject", "subject_dummy")
...
class TypeAliasStmt(Statement):
    __slots__ = ("alias_node", "invalid_recursive_alias", "name", "type_args", "value")
...
class NameExpr(RefExpr):
    ...
    __slots__ = ("is_special_form", "name")
...
class CallExpr(Expression):
    ...
    __slots__ = ("analyzed", "arg_kinds", "arg_names", "args", "callee")
...
class IndexExpr(Expression):
    ...
    __slots__ = ("analyzed", "base", "index", "method_type")
...
class ComparisonExpr(Expression):
    ...
    __slots__ = ("method_types", "operands", "operators")
...
class RevealExpr(Expression):
    ...
    __slots__ = ("expr", "is_imported", "kind", "local_nodes")
...
class GeneratorExpr(Expression):
    ...
    __slots__ = ("condlists", "indices", "is_async", "left_expr", "sequences")
...
class DictionaryComprehension(Expression):
    ...
    __slots__ = ("condlists", "indices", "is_async", "key", "sequences", "value")
...
class ConditionalExpr(Expression):
    ...
    __slots__ = ("cond", "else_expr", "if_expr")
...
class TypeVarLikeExpr(SymbolNode, Expression):
    ...
    __slots__ = ("_fullname", "_name", "default", "is_new_style", "upper_bound", "variance")
    ...
    def get_method(self, name: str) -> FuncBase | Decorator | None:
        for cls in self.mro:
            if name in cls.names:
                ...
                if isinstance(node, SYMBOL_FUNCBASE_TYPES) or isinstance(node, Decorator):
                    return node
                return None
        return None
...
class PlaceholderNode(SymbolNode):
    ...
    __slots__ = ("_fullname", "becomes_typeinfo", "node")
