    ...
    def visit_instance(self, template: Instance) -> list[Constraint]:
        ...
        if isinstance(actual, Instance):
            ...
            if self.direction == SUBTYPE_OF and template.type.has_base(instance.type.fullname):
                ...
                return res
            if self.direction == SUPERTYPE_OF and instance.type.has_base(template.type.fullname):
        ...
        if (
            ...
            for item in actual.items:
                ...
                res.extend(cb)
            return res
        if isinstance(actual, TupleType) and self.direction == SUPERTYPE_OF:
        ...
        if isinstance(actual, TypeVarType):
            ...
            return []
        if isinstance(actual, ParamSpecType):
            return infer_constraints(template, actual.upper_bound, self.direction)
        if isinstance(actual, TypeVarTupleType):
            raise NotImplementedError
        return []
    ...
    def visit_callable_type(self, template: CallableType) -> list[Constraint]:
        ...
        if isinstance(self.actual, CallableType):
            ...
            if param_spec is None:
                ...
                elif len(param_spec.prefix.arg_types) <= len(cactual_ps.prefix.arg_types):
        ...
        if isinstance(self.actual, Instance):
