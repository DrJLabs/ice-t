...
def infer_method_ret_type(name: str) -> str | None:
    ...
    if name.startswith("__") and name.endswith("__"):
        ...
        if name in ("eq", "ne", "lt", "le", "gt", "ge", "contains"):
            return "bool"
        if name in ("len", "length_hint", "index", "hash", "sizeof", "trunc", "floor", "ceil"):
            return "int"
        if name in ("format", "repr"):
            return "str"
        if name in ("init", "setitem", "del", "delitem"):
            return "None"
    return None
