...
def constant_fold_binary_op(
    ...
    if (isinstance(left, float) and isinstance(right, float)) or (isinstance(left, float) and isinstance(right, int)):
    ...
    if op == "+" and isinstance(left, str) and isinstance(right, str):
        return left + right
    if (op == "*" and isinstance(left, str) and isinstance(right, int)) or (op == "*" and isinstance(left, int) and isinstance(right, str)):
        return left * right

    # Complex construction.
    if (op == "+" and isinstance(left, (int, float)) and isinstance(right, complex)) or (op == "+" and isinstance(left, complex) and isinstance(right, (int, float))):
        return left + right
    if (op == "-" and isinstance(left, (int, float)) and isinstance(right, complex)) or (op == "-" and isinstance(left, complex) and isinstance(right, (int, float))):
        return left - right
