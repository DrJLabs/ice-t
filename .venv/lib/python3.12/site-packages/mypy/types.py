...
class Type(mypy.nodes.Context):
    ...
    __slots__ = ("_can_be_false", "_can_be_true")
...
class TypeVarLikeType(ProperType):
    __slots__ = ("default", "fullname", "id", "name", "upper_bound")
...
class ParamSpecType(TypeVarLikeType):
    ...
    def name_with_suffix(self) -> str:
        ...
        if self.flavor == ParamSpecFlavor.ARGS:
            return f"{n}.args"
        if self.flavor == ParamSpecFlavor.KWARGS:
            return f"{n}.kwargs"
        return n
...
class TypeVarTupleType(TypeVarLikeType):
    ...
    __slots__ = ("min_len", "tuple_fallback")
...
class CallableArgument(ProperType):
    ...
    __slots__ = ("constructor", "name", "typ")
...
class UnpackType(ProperType):
    ...
    __slots__ = ["from_star_syntax", "type"]
...
class AnyType(ProperType):
    ...
    __slots__ = ("missing_import_name", "source_any", "type_of_any")
...
class Instance(ProperType):
    ...
    __slots__ = ("_hash", "args", "extra_attrs", "invalid", "last_known_value", "type", "type_ref")
...
class TupleType(ProperType):
    ...
    __slots__ = ("implicit", "items", "partial_fallback")
...
class RawExpressionType(ProperType):
    ...
    __slots__ = ("base_type_name", "literal_value", "note")
...
class LiteralType(ProperType):
    ...
    __slots__ = ("_hash", "fallback", "value")
