...
_POSIX_CLASSES = set(['ALNUM', 'DIGIT', 'PUNCT', 'XDIGIT'])

_BINARY_VALUES = set(['YES', 'Y', 'NO', 'N', 'TRUE', 'T', 'FALSE', 'F'])
...
class ZeroWidthBase(RegexBase):
    ...
    def dump(self, indent, reverse):
        print(f"{INDENT * indent}{self._op_name} {POS_TEXT[self.positive]}")
...
class Property(RegexBase):
    ...
    def dump(self, indent, reverse):
        ...
        print(f"{INDENT * indent}PROPERTY {POS_TEXT[self.positive]} {name}:{value}{CASE_TEXT[self.case_flags]}")
