...
from ._compat import PermissionError, ProcessLookupError, long
...
if LINUX:
    ...
    from ._pslinux import (
        IOPRIO_CLASS_BE,  # NOQA
        IOPRIO_CLASS_IDLE,  # NOQA
        IOPRIO_CLASS_NONE,  # NOQA
        IOPRIO_CLASS_RT,  # NOQA
    )

elif WINDOWS:
    from . import _pswindows as _psplatform
    from ._psutil_windows import (
        ABOVE_NORMAL_PRIORITY_CLASS,  # NOQA
        BELOW_NORMAL_PRIORITY_CLASS,  # NOQA
        HIGH_PRIORITY_CLASS,  # NOQA
        IDLE_PRIORITY_CLASS,  # NOQA
        NORMAL_PRIORITY_CLASS,  # NOQA
        REALTIME_PRIORITY_CLASS,  # NOQA
    )
    from ._pswindows import (
        CONN_DELETE_TCB,  # NOQA
        IOPRIO_HIGH,  # NOQA
        IOPRIO_LOW,  # NOQA
        IOPRIO_NORMAL,  # NOQA
        IOPRIO_VERYLOW,  # NOQA
