...
class Mapper:
    ...
    def type_to_rtype(self, typ: Type | None) -> RType:
        ...
        if isinstance(typ, Instance):
            ...
            if typ.type.fullname == "builtins.bytes":
                return bytes_rprimitive
            if typ.type.fullname == "builtins.list":
            ...
            if any(cls.fullname == "builtins.dict" for cls in typ.type.mro):
                return dict_rprimitive
            if typ.type.fullname == "builtins.set":
                return set_rprimitive
            if typ.type.fullname == "builtins.frozenset":
                return frozenset_rprimitive
            if typ.type.fullname == "builtins.tuple":
                return tuple_rprimitive  # Varying-length tuple
            if typ.type.fullname == "builtins.range":
                return range_rprimitive
            if typ.type in self.type_to_ir:
                ...
                return inst
            if typ.type.fullname == "mypy_extensions.i64":
                return int64_rprimitive
            if typ.type.fullname == "mypy_extensions.i32":
                return int32_rprimitive
            if typ.type.fullname == "mypy_extensions.i16":
                return int16_rprimitive
            if typ.type.fullname == "mypy_extensions.u8":
        ...
        if isinstance(typ, AnyType) or isinstance(typ, TypeType):
            return object_rprimitive
        ...
        if isinstance(typ, (UninhabitedType, UnboundType)):
            # Sure, whatever!
            return object_rprimitive
