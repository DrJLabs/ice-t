...
def get_mypyc_attr_literal(e: Expression) -> Any:
    ...
    if isinstance(e, (StrExpr, IntExpr, FloatExpr)):
        return e.value
    if isinstance(e, RefExpr) and e.fullname == "builtins.True":
        return True
    if isinstance(e, RefExpr) and e.fullname == "builtins.False":
        return False
    if isinstance(e, RefExpr) and e.fullname == "builtins.None":
        return None
