...
from dparse import filetypes, parse, parser, updater
...
class Requirement:
    ...
    def __str__(self) -> str:
        return f"Requirement.parse({self.line}, {self.lineno})"
    ...
    def get_hashes(self, version: str) -> List:
        ...
        """
        r = requests.get(f'https://pypi.org/pypi/{self.key}/{version}/json')
        hashes = []
        data = r.json()
