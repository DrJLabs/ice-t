...
def process_report(
    ...
    **kwargs,
    ...
    with console.status(WAIT_MSG_PROCESSING_REPORT, spinner=DEFAULT_SPINNER) as status:
        ...
        report_to_export = save_as_format_mapping.get(export_type)
        report_to_output = output_format_mapping.get(output)
...
def system_scan(
    ...
    with console.status(":mag:", spinner=DEFAULT_SPINNER) as status:
        ...
        if FileType.SAFETY_PROJECT.value in file_paths:
