...
import string
import sys
from typing import TYPE_CHECKING, Any, List, NamedTuple, Set, cast
...
class ToxEnv(ABC):
    ...
    def register_config(self) -> None:
        ...
        assert self.installer is not None  # trigger installer creation to allow config registration
    ...
    def _clean(self, transitive: bool = False) -> None:  # noqa: ARG002
