...
def _get_params(func: Callable) -> dict[str, inspect.Parameter]:
    ...
    try:
        ...
        if (params := _get_params_ufunc(func)) or (params := _get_params_builtin_fn(func)):
            pass
        else:
...
def _is_probably_ufunc(obj):
    ...
    has_attributes = ["nin", "nout", "nargs", "ntypes", "types", "identity", "signature"]
    ...
    *,
    ...
    def maker(
        ...
        imports, body = _make_test_body(
            ...
            assertions=assertions,
            style=style,
            given_strategies={**strategies, **dict.fromkeys(args, operands_name)},
            annotate=annotate,
        )
