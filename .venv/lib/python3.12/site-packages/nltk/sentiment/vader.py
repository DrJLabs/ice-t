...
class SentimentIntensityAnalyzer:
    ...
    def _idioms_check(self, valence, words_and_emoticons, i):
        ...
        twoonezero = f"{words_and_emoticons[i - 2]} {words_and_emoticons[i - 1]} {words_and_emoticons[i]}"

        twoone = f"{words_and_emoticons[i - 2]} {words_and_emoticons[i - 1]}"

        threetwoone = f"{words_and_emoticons[i - 3]} {words_and_emoticons[i - 2]} {words_and_emoticons[i - 1]}"

        threetwo = f"{words_and_emoticons[i - 3]} {words_and_emoticons[i - 2]}"
        ...
        if len(words_and_emoticons) - 1 > i + 1:
            zeroonetwo = f"{words_and_emoticons[i]} {words_and_emoticons[i + 1]} {words_and_emoticons[i + 2]}"
