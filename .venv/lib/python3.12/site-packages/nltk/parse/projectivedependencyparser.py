            ...
            for node_index in range(1, len(dg.nodes)):
                ...
                for child_index in range(
                    ...
                    if child_index < 0:
                        ...
                        head_event = f"(head ({child} {child_tag}) (mods ({prev_tag}, {head_word}, {head_tag}) left))"
                        mod_event = f"(mods ({prev_tag}, {head_word}, {head_tag}) left))"
                        events[head_event] += 1
                        events[mod_event] += 1
                    elif child_index > 0:
                        ...
                        if child != "STOP":
                            productions.append(DependencyProduction(head_word, [child]))
                        head_event = f"(head ({child} {child_tag}) (mods ({prev_tag}, {head_word}, {head_tag}) right))"
                        mod_event = f"(mods ({prev_tag}, {head_word}, {head_tag}) right))"
                        events[head_event] += 1
                        events[mod_event] += 1
