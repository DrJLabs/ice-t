...
class TestSennaPipeline(unittest.TestCase):
    ...
    def test_senna_pipeline(self):
        ...
        sent = ["Dusseldorf", "is", "an", "international", "business", "center"]
        result = [
...
class TestSennaTagger(unittest.TestCase):
    ...
    def test_senna_tagger(self):
        ...
        result = tagger.tag(["What", "is", "the", "airspeed", "of", "an", "unladen", "swallow", "?"])
        expected = [
            ("What", "WP"),
            ("is", "VBZ"),
            ("the", "DT"),
    ...
    def test_senna_chunk_tagger(self):
        ...
        result_1 = chktagger.tag(["What", "is", "the", "airspeed", "of", "an", "unladen", "swallow", "?"])
        expected_1 = [
            ("What", "B-NP"),
            ("is", "B-VP"),
            ("the", "B-NP"),
    ...
    def test_senna_ner_tagger(self):
        ...
        result_1 = nertagger.tag(["Shakespeare", "theatre", "was", "in", "London", "."])
        expected_1 = [
            ("Shakespeare", "B-PER"),
            ("theatre", "O"),
            ("was", "O"),
        ...
        result_2 = nertagger.tag(["UN", "headquarters", "are", "in", "NY", ",", "USA", "."])
        expected_2 = [
            ("UN", "B-ORG"),
            ("headquarters", "O"),
            ("are", "O"),
