...
def load(
    ...
    if path_[-7:] == ".pickle":
        ...
        if path_.startswith("chunkers/maxent_ne_chunker"):
            return switch_chunker(fil.split("_")[-1])
        if path_.startswith("taggers/maxent_treebank_pos_tagger"):
            return switch_t_tagger()
        if path_.startswith("taggers/averaged_perceptron_tagger"):
