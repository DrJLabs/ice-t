        ...
        for i in range(N):
            for j in range(i, N):
                if cell_edges[i][j] == 0:
                    ...
                    color = f"#00{min(255, 50 + 128 * cell_edges[i][j] / 10):02x}{max(0, 128 - 128 * cell_edges[i][j] / 10):02x}"
...
class ChartComparer:
    ...
    def _update(self, operator, out_chart):
        ...
        self._out_label["text"] = f"{self._left_name} {self._operator} {self._right_name}"
